...
<div class="table-responsive1">
		<table>
				<tr class="table-header">
					<th class="darkgrayB">Driver ID</th>
					<th class="darkgrayB">First Name</th>
					<th class="darkgrayB">Last Name</th>
					<th class="darkgrayA">Date of Birth</th>
					<th class="darkgrayB">Email</th>
					<th class="darkgrayB">Phone Number</th>
					<th class="darkgrayB">Gender</th>
					<th class="darkgrayA">Driving License No</th>
				</tr>
			...
			if($result->num_rows>0){
				while($row=$result->fetch_assoc()){
					echo"<tr><td class='text-leftB'>".$row["driverID"]."</td><td class='text-leftB'>".$row["fName"]."</td><td class='text-leftB'>".$row["lName"]."</td><td class='text-leftA'>".$row["DOB"]."</td><td class='text-leftB'>".$row["Email"]."</td><td class='text-leftB'>".$row["pNumber"]."</td><td class='text-leftB'>".$row["gender"]."</td><td class='text-leftA'>".$row["drivingLicenseNo"]."</td></tr>";
				}
			}
			else{
				echo"Empty Table";
